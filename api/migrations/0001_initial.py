# Generated by Django 3.0.5 on 2020-11-24 05:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('moderator', 'Moderator'), ('admin', 'Admin'), ('django_admin', 'Django Admin')], default='user', help_text='Права пользователя', max_length=50, verbose_name='Права')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(help_text='Оценка пользователя', validators=[api.models.Review.validate_score], verbose_name='Оценка')),
